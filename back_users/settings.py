"""
Django settings for back_users project.
...
WSGI_APPLICATION = 'back_users.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'exlzccQbgIUSppVmsefLOizUKWUnqDjx',
